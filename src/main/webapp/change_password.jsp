                ...
                <div id="login-box" class="col-md-12">
                    <form id="login-form" class="form" action="controller?action=changePassword" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password_old" id="passwordOld" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="passwordNew" class="text-info text-black">new password:</label><br>
                            <input type="password" name="password_new" id="passwordNew" class="form-control" required>
                        </div>
